...
public class TimeSlotController {
    ...
    public SuccessResponse<List<ApplicationResponseDTO.Detail>> getApplicationsByTimeSlot(@PathVariable Long id) {
        return SuccessResponse.ok(timeSlotService.getApplicationsByTimeSlot(id));
    }
}
