...
public class RecruitmentResponseDTO {
    ...
    public record Detail(
            ...
            @Schema(description = "성별 입력 필요 여부") boolean needGender,
            @Schema(description = "주소 입력 필요 여부") boolean needAddress,
            @Schema(description = "학교 입력 필요 여부") boolean needSchool,
